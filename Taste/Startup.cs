...
namespace Taste
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Add Login by FaceBook
            services.AddAuthentication().AddFacebook(fasebookOption=> {
                fasebookOption.AppId = "663599377846065";
                fasebookOption.AppSecret = "467b84b3faa3099d3d37c49a4717730a";
            });
